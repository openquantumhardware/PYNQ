...
#
# Build PDI and export hardware platform for VRK160 sgloop overlay.
...
# Continuing past it produces an sgloop.pdi that looks fine and a build that
...
puts ""
puts "VRK160 sgloop overlay built successfully (Segmented Configuration):"
