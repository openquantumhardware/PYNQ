...
#
# Build PDI and export hardware platform for VRK160 base overlay.
...
# Continuing past it produces a base.pdi that looks fine and a build that
...
puts ""
puts "VRK160 base overlay built successfully (Segmented Configuration):"
