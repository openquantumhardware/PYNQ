...
#
#     make -C boards/VRK160/sgloop dtbo
#
...
set out [file normalize [file join $script_dir ../../../sgloop]]
set xsa [file join $out sgloop.xsa]
if {[catch {write_hw_platform -fixed -include_bit -force $xsa} msg]} {
    ...
    puts "Hog:   make -C boards/VRK160/sgloop pdi"
    puts "Hog: or from the Vivado GUI Tcl console with write_hw_platform."
} else {
    puts "Hog: wrote $xsa"
}
puts "Hog: then 'make -C boards/VRK160/sgloop dtbo' for the device tree overlay"
