# Builds the sgloop block design inside the project Hog has already created.
#
...
# so sourcing sgloop.tcl here does the right thing under both flows: the
...
# sgloop.tcl resolves its own paths from [info script], so sourcing it by its
